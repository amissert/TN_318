...
%For this analysis, we choose to remove the 
...
The correlation matrix obtained by executing this procedure can be seen
...
%    \includegraphics[width=0.65\textwidth]{hcor_v2}
    \includegraphics[width=0.65\textwidth]{skerr_tn186method_jun14_cor}
  \end{center}
...
%    \includegraphics[width=0.85\textwidth]{skerrs_1D}
    \includegraphics[width=0.85\textwidth]{skerr_tn186method_jun14_err.png}
  \end{center}
