...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=0.5\textwidth]{wall_towalldef}
  \end{center}
...
\begin{figure}
  \label{fig:fvbin}
  \begin{center}
    \includegraphics[width=0.5\textwidth]{hdr_binning}
  \end{center}
...
Since any mis-modeling of the Cherenkov rings should be independant of the
...
%  -log[P( h^{Data}_{j,l,m} | h^{MC}_{j,l,m}(\alpha,\beta,\gamma))] = \\
...
The remaining terms are the priors for each of the fit parameters.  We assume
